...
public class BoltWelcome : EditorWindow
{
    ...
    [NonSerialized]
    Texture2D _slackIcon;

    [NonSerialized]
    GUIContent _slackHeader;

    [NonSerialized]
    GUIContent _slackText;
...
#pragma warning restore
    ...
    void MainMenu()
    {
        ...
        DrawMenuOption(_slackIcon, _slackHeader, _slackText, OpenURL("https://photonbolt.herokuapp.com/"));
    ...
    void InitContent()
    {
        ...
        _slackIcon = Resources.Load<Texture2D>("icons_welcome/community");
        _slackText = new GUIContent("Join the Bolt Slack Community.");
        _slackHeader = new GUIContent("Community");
